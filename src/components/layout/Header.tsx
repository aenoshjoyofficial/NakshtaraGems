...
const ANNOUNCEMENT_TEXTS = [
  "Complimentary FedEx® Insured Shipping on All Orders",
  "Discover the Solitaire Collection: Conflict-Free & Certified GIA",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4 md:space-x-6 text-luxury-black">
              ...
              <Link href="/dashboard" className="hidden sm:inline-block hover:text-luxury-gold transition-colors" aria-label="Account">
          ...
          >
            ...
            >
              ...
              <div className="border-t border-luxury-gold/20 pt-6">
                <Link href="/dashboard" className="flex items-center gap-3 text-xs uppercase tracking-widest font-semibold text-luxury-black/90 mb-4" onClick={() => setMobileMenuOpen(false)}>
